...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displaySelectedScreen(R.id.nav_bookService);
    }
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_serviceStatus:
                fragment = new frag_serviceStatus();
                break;
            case R.id.nav_bookService:
                fragment = new frag_bookService();
                break;
            case R.id.nav_serviceHistory:
